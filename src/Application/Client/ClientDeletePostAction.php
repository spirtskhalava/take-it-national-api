...
final class ClientDeletePostAction extends AbstractAction
{
    /**
     * @inheritdoc
     */
    ...
    {
        try {
            $command = new DeleteClientCommand((int)$args['id']);
            /** @throws DBALException */
            /** @see DeleteClientHandler */
            if (!(bool)$this->commandBus->handle($command)) {
                return new InternalServerErrorResponse('Unable to delete client');
            }
