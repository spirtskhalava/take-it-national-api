...
final class FunnelElementAttributeUpdatePutAction extends AbstractAction
{
    /**
     * @inheritdoc
     */
    ...
    {
        try {
            $command = new UpdateFunnelElementAttributeCommand((int)$args['id'], $request->getParsedBody());
        ...
        } catch (UpdateFunnelElementAttributeException $exception) { // from handler
