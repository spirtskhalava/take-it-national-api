...
final class WebsiteDeletePostAction extends AbstractAction
{
    /**
     * @inheritdoc
     */
    ...
    {
        try {
            $command = new DeleteWebsiteCommand((int)$args['id']);
            /** @throws DBALException */
            /** @see DeleteFunnelElementAttributeHandler */
            if (!(bool)$this->commandBus->handle($command)) {
                return new InternalServerErrorResponse('Unable to delete website');
            }
