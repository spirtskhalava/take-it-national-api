...
final class GetWebsiteListHandler
{
    /**
    ...
    /**
     * GetWebsiteListHandler constructor.
    ...
    /**
     * @param GetWebsiteListCommand $command
     * @return array
     */
    public function handle(GetWebsiteListCommand $command): array
    {
        ...
        return empty($command->getClientId())
            ? $this->repository->findAll($queryParams, $command->getToken())
            : $this->repository->findAllByClientId($command->getClientId(), $queryParams);
    }
}
