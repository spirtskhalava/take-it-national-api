...
final class WebsiteUpdatePutAction extends AbstractAction
{
    /**
     * @inheritdoc
     */
    ...
    {
        try {
            $command = new UpdateWebsiteCommand((int)$args['id'], $request->getParsedBody());
        ...
        } catch (UpdateWebsiteException $exception) { // from handler
